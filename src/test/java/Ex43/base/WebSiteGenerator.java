...
/*
    ...
    js := READ THE OPTION FROM USER, IF HE WANT TO CREATE SEPERATE FOLDEER FOR JS FILES
    css := READ THE OPTION FROM USER, IF HE WANT TO CREATE SEPERATE FOLDER FOR CSS FILES

    currentPath = INITIALIZE THE CURRENT PATH
    CREATE THE REQUIRED FOLDERS AND FILES INSIDE THEM
}
 */
